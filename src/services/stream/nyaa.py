...
_num_extractors = [re.compile(x, re.I) for x in [
	...
	r"\[(?:horriblesubs|SubsPlease|commie|hiryuu|kuusou|fff|merchant|lolisubs|hitoku|erai-raws|davinci|asenshi|mezashite|anonyneko|pas|ryuujitk|rip time|Seigyoku)\] .+ - (\d+) ",
	r"\[DameDesuYo\] .+ - (\d+)[ v]",
	r"\[Some-Stuffs\] .+ (\d{3}) ",
